...
urlpatterns = [
    ...
    path('confirmar-mapa-final/', views.confirmar_mapa_final, name='confirmar_mapa_final'),
    ...
    path('formulario/mapa/', views.formulario_mapa, name='formulario_mapa'),
    path('formulario/multimedia/', views.formulario_multimedia, name='formulario_multimedia'),
    path('formulario/notebook/', views.formulario_notebook, name='formulario_notebook'),
    path('formulario/proyector/', views.formulario_proyector, name='formulario_proyector'),
    path('formulario/varios/', views.formulario_varios, name='formulario_varios'),
