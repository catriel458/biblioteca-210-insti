...
class Inventario(models.Model):
    ...
    imagen_rota_nombre = models.CharField(max_length=255, null=True, blank=True)
    imagen_rota_contenido = models.BinaryField(null=True, blank=True)
    imagen_rota_tipo = models.CharField(max_length=50, null=True, blank=True)
