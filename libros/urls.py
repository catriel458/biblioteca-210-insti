...
urlpatterns = [
    ...
    path('home/', views.pantalla_principal, name='home'),
    # 🆕 AGREGAR ESTA LÍNEA:
    path('alta-programa/', views.alta_programa, name='alta_programa'),
     
    # 🆕 URL PRINCIPAL PARA ALTA DE MATERIAL (formulario dinámico)
    path('alta-material/', views.alta_material, name='alta_material'),
    # URLs de libros
    ...
    path('materiales/get_material_template/<str:tipo>/', views.get_material_template, name='get_material_template'),
]